// Definición de los 50 logros.
// "stat" indica de dónde sale el valor actual (calculado en statsEngine.js)
// "target" es el valor necesario para desbloquear
// "tier" es solo estético (bronze/silver/gold/diamond) según dificultad
...
const ACHIEVEMENTS = [
  ...
  // ---------- ECONOMÍA / CLUTCHES (si disponible en API) ----------
